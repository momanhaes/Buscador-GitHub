...
export const BUTTONS: IButton[] = [
  {
    ...
    label: 'Primary Icon',
    disabled: false,
    code: '<app-button theme="primary" label="Primary Icon" [icon]="fa fa-smile-o"></app-button>',
    icon: 'fa fa-smile-o',
  },
  {
    theme: 'primary',
    label: 'Primary',
    disabled: false,
    code: '<app-button theme="primary" label="Primary" [icon]="fa fa-smile-o"></app-button>',
  },
  {
    theme: 'basic',
    label: 'Basic Icon',
    disabled: false,
    code: '<app-button theme="basic" label="Basic Icon" [icon]="fa fa-smile-o"></app-button>',
    icon: 'fa fa-smile-o',
  },
  {
    theme: 'basic',
  ...
  },
  {
    ...
    label: 'Accent Icon',
    disabled: false,
    code: '<app-button theme="accent" label="Accent Icon" [icon]="fa fa-smile-o"></app-button>',
    icon: 'fa fa-smile-o',
  },
  {
    theme: 'accent',
  ...
  },
  {
    ...
    label: 'Warn Icon',
    disabled: false,
    code: '<app-button theme="warn" label="Warn Icon" [icon]="fa fa-smile-o"></app-button>',
    icon: 'fa fa-smile-o',
  },
  {
    theme: 'warn',
  ...
  },
  {
    ...
    label: 'Outline Icon',
    disabled: false,
    code: '<app-button theme="outline" label="Outline Icon" [icon]="fa fa-smile-o"></app-button>',
    icon: 'fa fa-smile-o',
  },
  {
    theme: 'outline',
