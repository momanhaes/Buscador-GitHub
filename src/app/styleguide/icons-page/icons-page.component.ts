...
import { IStyleguideCountryIcon, IStyleguideIcon } from 'src/app/shared/interfaces/styleguide.interface';
import { StyleguideService } from '../../shared/services/styleguide.service';
import { COUNTRIES, ICONS } from '../styleguide.content';
...
export class IconsPageComponent implements OnInit {
  public icons: IStyleguideIcon[] = ICONS;
  public countries: IStyleguideCountryIcon[] = COUNTRIES;
  public state = 'ready';
  public show!: boolean;
